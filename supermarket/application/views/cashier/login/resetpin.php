...
<head>
    ...
    <title>Reset Login Pin | <?= AppName ?></title>
            ...
            <div class="card">
                <div class="card-content ">
                    <div class="text-center">
                        ...
                        <h2><?= AppName ?></h2>
                        <h3 class="card-title">Recover my login Pin</h3>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            <div class="col-sm-12">
                                <form class="form" action="<?= base_url('Cashier/Login/recover') ?>" method="post" enctype="multipart/form-data" data-parsley-validate>
                                    ...
                                    <!--<div class="row mt-5">-->
                                        <!--<div class="col-md-10">-->
                                            ...
                                            <p class="text-inverse text-left mt-5"><a href="<?php echo base_url(); ?>Cashier/login"><b class="f-w-600">Back
                                                        to login</b></a></p>
                                        <!--</div>-->
                                        <div class="col-md-2">
