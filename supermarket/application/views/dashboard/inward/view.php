				...
				<div class="col-12">
					<div class="card">
						<div class="card-header">
							<h3><?php echo $translations['View Inward']?><span style="float:right"><a id="cancelDefaultButton" href="<?= base_url() ?>inward/listRecords" class="btn btn-sm btn-primary"><?php echo $translations['Back']?></a></span></h3>
						</div>
