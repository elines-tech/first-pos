				...
				<div class="col-12">
					<div class="card">
						<div class="card-header">
							<h3>
								<?php echo $translations['View Order']?>
								<span class="float-end"><a id="cancelDefaultButton" href="<?= base_url("order/listRecords") ?>" class="btn btn-sm btn-outline-info"><?php echo $translations['Back']?></a></span>
							</h3>
						</div>
								...
								?>
										<div class="col-12">
											<div class="row">
												...
												<div class="col-md-4 col-12">
													<div class="form-group mandatory">
														<label for="txnId"><?php echo $translations['Transaction Number']?></label>
										...
										<div class="col-12 mt-4">
											<h4><?php echo $translations['Product Details']?></h4>
											<hr />
												...
												<table id="datatableOrderDetails" class="table table-striped table-bordered">
													<thead>
														<tr>
															...
															<th><?php echo $translations['Quantity Unit']?></th>
															<th><?php echo $translations['Price']?></th>
															<th><?php echo $translations['Subtotal']?></th>
															<th><?php echo $translations['Discount price']?></th>
															<th><?php echo $translations['Tax']?></th>
											...
											<div class="row mt-2 float-right">
												...
												<div class="col-md-6 offset-md-6">
													<b style="width:100%"><label><?php echo $translations['Total Product Discount']?></label><span style="float:right;"><?= number_format($row->discountTotal, 2, '.', '') ?></span></b>
												</div>
												<div class="col-md-6 offset-md-6">
													<b style="width:100%"><label><?php echo $translations['Total Offer Discount']?></label><span style="float:right;"><?= number_format($row->offerDiscountTotal, 2, '.', '') ?></span></b>
												</div>
												<div class="col-md-6 offset-md-6">
													<b style="width:100%"><label><?php echo $translations['Total Gift Discount']?></label><span style="float:right;"><?= number_format($row->giftDiscountTotal, 2, '.', '') ?></span></b>
												</div>
												<div class="col-md-6 offset-md-6">
													<b style="width:100%"><label><?php echo $translations['Actual Tax (+)']?></label><span style="float:right;"><?= number_format($row->totalTax, 2, '.', '') ?></span></b>
												</div>
												<div class="col-md-6 offset-md-6">
													<div style="border-bottom:2px dashed;margin:10px 0"></div>
												</div>
												<div class="col-md-6 offset-md-6">
													<b style="width:100%;"><label><?php echo $translations['Grand Total']?></label><span style="float:right;"><?= number_format($row->totalPayable, 2, '.', '') ?></span></b>
												</div>
											</div>
										</div>
								<?php
