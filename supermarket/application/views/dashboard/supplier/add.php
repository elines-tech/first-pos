                ...
                <div class="col-12 col-md-6 order-md-2 order-first">
                    <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page"><?php echo $translations['Supplier']?></li>
                        </ol>
                    </nav>
                </div>
            </div>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3><?php echo $translations['Add Supplier']?><span style="float:right"><a id="cancelDefaultButton" href="<?= base_url() ?>supplier/listRecords" class="btn btn-sm btn-primary"><?php echo $translations['Back']?></a></span></h3>
                        </div>
                                ...
                                <form class="form" action="<?= base_url('Supplier/save') ?>" method="post" enctype="multipart/form-data" data-parsley-validate>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6 col-12">
                                                    <div class="form-group mandatory">
                                                        <label for="suppliername" class="form-label mb-2"><?php echo $translations['Name']?></label>
                                    ...
                                    <div class="row">
                                        <div class="col-12 d-flex justify-content-end">
                                            <button id="saveDefaultButton" type="submit" class="btn btn-success"><?php echo $translations['Save']?></button>
