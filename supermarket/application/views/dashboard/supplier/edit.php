            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h3>Update Supplier<span style="float:right"><a href="<?= base_url()?>supplier/listRecords" class="btn btn-sm btn-primary m-1">Back</a></span></h3>
                    </div>
													...
													<div class="input-group">
														<div class="input-group-prepend">
															<select class="form-select" id="countryCode" onchange="setPattern()" name="countryCode" required>
																<option value="+966" <?php if($supplierData[0]['countryCode']=='966'){ echo 'selected';}?> data-pattern="^\d{9}$" selected>+966 SAU</option>
																<option value="+971" <?php if($supplierData[0]['countryCode']=='971'){ echo 'selected';}?> data-pattern="^\d{9}$">+971 UAE</option>
															</select>
														</div>
