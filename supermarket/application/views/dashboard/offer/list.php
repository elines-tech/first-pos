        ...
        <section class="section">
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        <div class="col-12 col-md-6 order-md-1 order-last" id="leftdiv">
                            <h5><?php echo $translations['Offer List']?></h5>
                        </div>
                    ...
                    <table class="table table-striped table-responsive display" id="dataTableOffer">
                        <thead>
                            <tr>
                                ...
                                <th><?php echo $translations['Offer Title']?></th>
                                <th><?php echo $translations['Offer Type']?></th>
                                <th><?php echo $translations['Discount']?></th>
                                <th><?php echo $translations['Minimum Amount']?></th>
