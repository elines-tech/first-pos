			...
			<div class="col-12">
				<div class="card">
					<div class="card-header">
						<h3>View Coupon<span style="float:right"><a href="<?= base_url()?>coupon/listRecords" class="btn btn-sm btn-primary">Back</a></span></h3>
					</div>
										...
										<div class="row">
											...
											<div class="col-md-4 col-12">
												<div class="form-group mandatory">
													...
													<input type="text" id="couponCode" disabled  name="couponCode" class="form-control" required value="<?= $result->couponCode?>"> 
												</div>
											</div>
											<div class="col-md-4 col-12">
												<div class="form-group mandatory">
													<label for="product-name" class="form-label">Offer type</label>
													<select id="offerType" name="offerType" class="form-control" disabled required>
											...
											<div class="col-md-4 col-12">
												<div class="form-group mandatory">
													...
													<input type="number" id="perUserLimit" name="perUserLimit" disabled class="form-control" required value="<?= $result->perUserLimit?>">
												</div>
											</div>
										...
										<div class="row">
											<div class="col-md-4 col-12">
												<div class="form-group mandatory">
													...
													<input type="number" id="minimumAmount" name="minimumAmount" disabled class="form-control" required value="<?= $result->minimumAmount?>">
												</div>
											</div>
										...
										<div class="row">
											<div class="col-md-6 col-12">
												<div class="form-group mandatory">
													...
													<textarea class="form-control" id="termsAndConditions" disabled  name="termsAndConditions" placeholder="Terms and Conditions"><?= $result->termsAndConditions?></textarea>
												</div>
											</div>
										</div>
										<div class="row">
											<div class="col-md-6 col-12">
												<div class="form-group mandatory">
													<label for="" class="form-label">Start Date</label>
													 <input type="date" id="startDate" disabled name="startDate" class="form-control" required value="<?= $result->startDate?>">
												</div>
											</div>
											<div class="col-md-6 col-12">
												<div class="form-group mandatory">
													<label for="" class="form-label">End Date</label>
													 <input type="date" id="endDate" disabled name="endDate" class="form-control" required value="<?= $result->endDate?>">
												</div>
											</div>
