			...
			<div class="col-12">
				<div class="card">
					<div class="card-header">
						<h3>Add Coupon<span style="float:right"><a href="<?= base_url()?>coupon/listRecords" class="btn btn-sm btn-primary">Back</a></span></h3>
					</div>
												...
												<div class="form-group">
													...
													<div class="input-group">
														<div class="input-group-prepend"><span class="input-group-text bg-soft-primary">
																<input type="checkbox" checked id="isActive" name="isActive" class="form-check-input"></span>
														</div>
													</div>
												</div>
											</div>
				...
				success: function(response) {
					...
					if (obj.status) {
						toastr.success(obj.message, 'Coupon', {
							"progressBar": true, 
						    onHidden: function() {
								window.location.href = base_path + "coupon/listRecords";
							}
						});
					} else {
