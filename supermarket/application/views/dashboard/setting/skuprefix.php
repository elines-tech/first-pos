                    ...
                    <div class="card">
                        <div class="card-content">
                            <div class="card-body">
                                ...
                                ?>
                                <div class="row">
                                    <form class="form" id="editUserForm" enctype="multipart/form-data" data-parsley-validate method="post" action="<?php echo base_url('setting/update_skuprefix'); ?>">
                                        <?php
                                        $settingcode = "STG_1";
                                        ...
                                        <div class="row">
                                            <div class="col-md-4 col-12">
                                                <div class="form-group mandatory">
                                                    ...
                                                    <input type="text" id="settingValue" minlength="1" maxlength="4" class="form-control" placeholder="User Name" name="settingValue" value="<?= $settingValue ?>" data-parsley-required="true">
                                                </div>
...
<script>
    $(document).ready(function() {
        ...
        if (data != '') {
            ...
            if (obj.status) {
                toastr.success(obj.message, 'SKU Settings', {
                    "progressBar": true
                });
            } else {
                toastr.error(obj.message, 'SKU Settings', {
                    "progressBar": true
                });
            }
        }
