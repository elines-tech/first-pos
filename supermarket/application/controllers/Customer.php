...
class Customer extends CI_Controller
{
	...
	public function getCustomerList()
	{
		...
		$extraCondition = "";
		$like = array("customer.code" => $search . "~both","customer.name" => $search . "~both", "customer.code" => $search . "~both", "customer.email" => $search . "~both", "customer.country" => $search . "~both", "customer.state" => $search . "~both", "customer.city" => $search . "~both", "customer.pincode" => $search . "~both", "customer.phone" => $search . "~both", "customergroupmaster.customerGroupName" => $search . "~both");
