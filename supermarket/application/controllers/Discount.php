...
class Discount extends CI_Controller
{
	...
	public function listRecords()
	{
		...
		$this->load->view('dashboard/discount/list');
	...
	public function getDiscountList()
	{
		...
		$like = array("discountmaster.discount" => $search . "~both");
		...
		if ($Records) {
			foreach ($Records->result() as $row) {
				...
				$actionHtml = ' <a class="btn btn-sm btn-success cursor_pointer edit_discount" data-seq="' . $row->code . '" data-type="1"><i id="edt" title="View" class="fa fa-eye"></i></a>
					<a class="btn btn-sm btn-info cursor_pointer edit_discount" data-seq="' . $row->code . '" data-type="2"><i id="edt" title="Edit" class="fa fa-pencil"></i></a>
					<a class="btn btn-sm btn-danger cursor_pointer delete_discount" data-seq="' . $row->code . '"><i id="dlt" title="Delete" class="fa fa-trash"></i></a>';
