...
class Coupon extends CI_Controller
{
	...
	public function listRecords()
	{
		...
		$this->load->view('dashboard/coupon/list');
	...
	public function add()
	{
		...
		$this->load->view('dashboard/coupon/add');
		$this->load->view('dashboard/footer');
	}
	...
	public function getCouponList()
	{
		...
		if ($Records) {
			foreach ($Records->result() as $row) {
				...
				$actionHtml = '<div class="d-flex"> <a href="' . base_url() . 'coupon/view/' . $row->code . '" class="btn btn-success btn-sm cursor_pointer m-1"><i id="view" title="View" class="fa fa-eye"></i></a>
				<a href="' . base_url() . 'coupon/edit/' . $row->code . '" class="btn btn-info btn-sm m-1 cursor_pointer"><i id="edt" title="Edit" class="fa fa-pencil"></i></a>
					<a class="btn btn-danger btn-sm m-1 cursor_pointer delete_coupon" id="' . $row->code . '"><i id="dlt" title="Delete" class="fa fa-trash"></i></a></div>';
				$data[] = array(
					$srno,
					$row->code,
					$row->couponCode,
