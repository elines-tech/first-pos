...
class Supplier extends CI_Controller
{
    ...
    public function __construct()
    {
        ...
        $this->rights = $this->GlobalModel->getMenuRights('3.3', $rolecode);
        if ($this->rights == '') {
    ...
    public function getList()
    {
        ...
        $condition = array("suppliermaster.isDelete !="=>1);
        ...
        $like = array();
        $extraCondition = "";
        $like = array("suppliermaster.financialAccount" => $search . "~both","suppliermaster.code" => $search . "~both","suppliermaster.supplierName" => $search . "~both", "suppliermaster.arabicName" => $search . "~both", "suppliermaster.companyName" => $search . "~both", "suppliermaster.email" => $search . "~both", "suppliermaster.country" => $search . "~both", "suppliermaster.state" => $search . "~both", "suppliermaster.city" => $search . "~both", "suppliermaster.postalCode" => $search . "~both", "suppliermaster.phone" => $search . "~both");
        ...
        if ($Records) {
            foreach ($Records->result() as $row) {
                ...
                if ($this->rights != '' && $this->rights['view'] == 1) {
                    $actionHtml .= '<a id="view" href="' . base_url() . 'Supplier/view/' . $row->code . '" class="btn btn-sm btn-success m-1" ><i id="edt" title="View" class="fa fa-eye cursor_pointer" ></i></a>';
                }
                if ($this->rights != '' && $this->rights['update'] == 1) {
                    $actionHtml .= '<a id="edit" class="btn btn-sm btn-info m-1" href="' . base_url() . 'Supplier/edit/' . $row->code . '" ><i id="edt" title="Edit" class="fa fa-pencil cursor_pointer"></i></a>';
                }
                if ($this->rights != '' && $this->rights['delete'] == 1) {
                    $actionHtml .= '<a id="delete" class="btn btn-sm btn-danger delete_id  m-1" id="' . $row->code . '"  ><i title="Delete" id="edt" class="fa fa-trash cursor_pointer "></i></a>';
                }
