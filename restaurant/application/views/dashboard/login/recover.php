...
<head>
    ...
    <title>Recover Password | <?= AppName ?></title>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-12 col-12">
                                                <div class="form-group mandatory">
                                                    ...
                                                    <input type="password" id="confirmpassword" class="form-control" placeholder="Confirm Password" name="confirmPassword" data-parsley-required="true" onchange="checkPasswordMatch();">
                                                </div>
