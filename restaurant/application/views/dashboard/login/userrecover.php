...
<head>
    ...
    <title>User Password Recover | <?= AppName ?></title>
                    ...
                    <div class="card">
                        <div class="card-content">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-sm-12">
                                        <form class="form" action="<?= base_url('UserLogin/updateLoginPin') ?>" method="post" enctype="multipart/form-data" data-parsley-validate>
                                            <?php
                                            ...
                                            <div class="row">
                                                <div class="col-md-12 col-12">
                                                    <div class="form-group mandatory">
                                                        ...
                                                        <input type="text" id="loginpin" class="form-control" placeholder="Login Pin" name="loginpin" value="<?= $loginpin ?>" readonly>
                                                    </div>
                                            ...
                                            <div class="row mt-5">
                                                <div class="col-md-10">
                                                    ...
                                                    <p class="text-inverse text-left"><a href="<?php echo base_url(); ?>UserLogin/index"><b class="f-w-600">Back
                                                                to Login</b></a></p>
                                                </div>
                                                <div class="col-md-2">
