                    ...
                    <div class="card">
                        <div class="card-content">
                            <div class="card-body">
                                ...
                                ?>
                                <div class="row">
                                    <form class="form" id="editUserForm" enctype="multipart/form-data" data-parsley-validate method="post" action="<?php echo base_url('setting/update_ordercharge'); ?>">
                                        <?php
                                        $settingcode = "STG_1";
...
<script>
    $(document).ready(function() {
        ...
        if (data != '') {
            ...
            if (obj.status) {
                toastr.success(obj.message, 'Order Service Charge', {
                    "progressBar": true
                });
            } else {
                toastr.error(obj.message, 'Order Service Charge', {
                    "progressBar": true
                });
            }
        }
