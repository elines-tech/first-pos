...
<?php
$emailData = $smsData = $serviceChargeData = $waitingData = false;
if ($setting) {
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="tab-content" id="nav-tabContent">
                            <div class="tab-pane fade show active" id="nav-servicecharge" role="tabpanel" aria-labelledby="nav-serviceharge-tab">
                                <div class="col-12 p-3">
                                    ...
                                    if ($serviceChargeData) {
                                        $settingValue = $serviceChargeData->settingValue;
                                    }
                                    ?>
                            ...
                            <div class="tab-pane fade" id="nav-waitingtime" role="tabpanel" aria-labelledby="nav-waitingtime-tab">
                                <div class="col-12 p-3">
                                    <?php
                                    $settingValue = "";
                                    if ($waitingData) {
                                        $settingValue = $waitingData->settingValue;
                                    }
                                    ?>
