 <form class="form mb-5" id="updateBranchForm" data-parsley-validate>
     <div class="row">
         <?php
            if ($branch) {
                foreach ($branch->result() as $br) { ?>
                 ...
                 <div class="col-md-12 mb-2 row col-12">
                     ...
                     <div class="form-group col-md-6 col-12 mandatory">
                         <label for="category-name-column" class="col-md-4 form-label text-nowrap text-left">Tax Group</label>
                 ...
                 <div class="col-md-12 mb-2 col-12 row">
                     ...
                     <div class="form-group col-md-6 col-12">
                         <label for="category-name-column" class="col-md-4 form-label text-nowrap text-left">Tax Number</label>
                 ...
                 <div class="col-md-12 mb-2 row col-12">
                     <div class="form-group col-md-6 col-12">
                         <label for="category-name-column" class="col-md-4 form-label text-nowrap text-left">Opening From</label>
                         <input type="time" id="modalopeningFrom" class="form-control" name="modalopeningFrom" value="<?= $br->openingFrom ?>">
                     </div>


                     <div class="form-group col-md-6 col-12">
                         <label for="category-name-column" class="col-md-4 form-label text-nowrap text-left">Opening To</label>
                 ...
                 <div class="col-md-12 mb-2 col-12 row">
                     ...
                     <div class="form-group col-md-6 col-12">
                         <label for="category-name-column" class="col-md-4 form-label text-nowrap text-left">Receipt Header</label>
                         <textarea rows="3" id="modalreceiptHead" class="form-control" name="modalreceiptHead"><?= $br->receiptHead ?></textarea>
                     </div>


                     <div class="form-group col-md-6 col-12">
                         <label for="category-name-column" class="col-md-4 form-label text-nowrap text-left">Receipt Foot</label>
