                                                ...
                                                <div class="form-group">												
													...
													<div class="col-md-12">
													     <?php if ($userData[0]['userImage'] != "") { ?>
															<img class="img-thumbnail mb-2" width="200px" id="userimg" src="<?= base_url() . $userData[0]['userImage'] ?>" data-src="">
														<?php } else { ?>
															<img class="img-thumbnail mb-2" width="200px" id="userimg" src="/assets/images/faces/default-img.jpg" data-src="">
														<?php } ?>
