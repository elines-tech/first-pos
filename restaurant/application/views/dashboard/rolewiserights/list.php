				...
				<div class="card-body">
					<div class="row">
						<div class="col-md-12 col-sm-4">
							...
							<p class="col-md-12 col-12 d-flex items-center text-center justify-content-center">On this page you can define roles for all your users: Manager , Staff , Accounts, etc...</p>
						...
						<div class="col-md-12 justify-content-center items-center text-center d-flex col-sm-4">
