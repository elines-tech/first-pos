...
if ($sectors) {
    foreach ($sectors->result() as $sector) {
        $html = "<optgroup label='Sector - " . $sector->zoneName . "'>";
        if ($tables) {
            foreach ($tables->result() as $table) {
                if ($table->zoneCode == $sector->id) {
                    $html .= "<option value='" . $table->code . "' data-zone='" . $sector->zoneName . "' data-table-branch='" . $sector->branchCode . "' data-table-section='" . $table->zoneCode . "'>" . $table->tableNumber . "</option>";
                }
            }
        }
        $html .= "</optgroup>";
...
<div class="container-fluid pos-window">
    ...
    <div class="row my-2">
        <div class="col-8">
            <h5 class="mb-1">KAEM Restaurant </h5>
        ...
        <div class="col-4 text-end">
            ...
            <a class="btn btn-sm btn-outline-dark" href="<?= base_url('order/listRecords') ?>" title="Close page and back to orders"><i class="fa fa-times"></i></a>
        </div>
    </div>
                ...
                <form class="extablk" id="newCustomer" method="post" data-parsley-validate="">
                    <div class="row">
                        <div class="col-md-12 mb-2">
                            ...
                            <select id="modaltableCode" name="modaltableCode" class="form-control" required>
