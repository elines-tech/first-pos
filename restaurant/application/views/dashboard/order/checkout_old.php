...
<div class="container-fluid pos-window">
    ...
    <div class="row my-2">
        <div class="col-8">
            <h6 class="mb-1">KAEM Restaurant </h6>
            <small><b><?= date('d-m-Y') ?></b></small>
        </div>
        <div class="col-4 text-end">
            <a class="btn btn-sm btn-outline-primary" href="javascript:void(0)"><i class="fa fa-expand"></i></a>
            <a class="btn btn-sm btn-outline-dark" href="<?= base_url('order/listRecords') ?>"><i class="fa fa-times"></i></a>
        </div>
    </div>
									...
									<div class="col-md-8 col-12">
										<div class="bg-light padcls mb-2">
											<div class="row col-12">
												<div class="col-md-4 col-12"><h6>Branch: <?= $orderDetails->result()[0]->custPhone?></h6></div>
												...
												<div class="col-md-4 col-12"><h6>Sector Zone: <?= $orderDetails->result()[0]->zoneName?></h6></div>
												<div class="col-md-4 col-12"><h6>Table Number: <?= $orderDetails->result()[0]->tableNumber?></h6></div>
												<hr>
												<div class="col-md-4 col-12"><h6>Name : <?= $orderDetails->result()[0]->custName?></h6></div>
												<div class="col-md-4 col-12"><h6>Phone : <?= $orderDetails->result()[0]->custPhone?></h6></div>
														...
														if($orderDetails){
															foreach($orderDetails->result() as $r){
																...
																if($r->isCombo==1){
																	...
																	if(${'comboprd'.$r->cartPrdId}){
																		foreach(${'comboprd'.$r->cartPrdId}->result() as $cmbPrd){
																			$extraText .= $r->productQty."  ".$cmbPrd->productEngName.' '.number_format($cmbPrd->productPrice, 2, '.', '').', ';
																		}
																	}
																}elseif($r->addOns!='[]'){
																	$extraText = '<b>Addons: </b>';
																	$extras = json_decode($r->addOns, true);
																	if(${'extras'.$r->cartPrdId}){
																		foreach(${'extras'.$r->cartPrdId}->result() as $extrprd){
																			$extraText .= $extras[0]['addonQty']."  ".$extrprd->unitSName."  ".$extras[0]['addonTitle'] ."  ". $extras[0]['addonPrice'].', ';																		}
																	}
																}
																$cartHtml .= '<li id="productDiv'.$r->cartPrdId.'">
																		...
																		$cartHtml .='<div style="border-bottom:1px dashed rgb(24 24 25);min-height:115px;"> 
																			<div class="float-end"><a class="btn btn-sm btn-danger" onclick="deleteProduct('.$r->cartPrdId.')" id="productRemoveBtn'.$r->cartPrdId.'"><i class="fa fa-times"></i></a></div>
																			<div class="row cartSection">
																				...
																				<div class="col-md-7 col-12">
																					<h6>'.$productName.'<span class="badge bg-success" style="margin-left:10px;">'.$r->productQty.' X '.$productPrice.'</span></h6>
																					<div class="extra">
																						'.rtrim($extraText,', ').'
																					</div>
																				</div>
										...
										<div class="row col-12">
											...
											<div class="col-md-4">
												...
												<div id="payment" class=" mycls bg-light">
													<select class="form-select select2" name="discount" id="discount" onchange="calculateAmount()">
														<option value="">Select</option>
														<?php
														if($discount){
										...
										<div class="maincart" id="checkoutcart">
											...
											<div class="priclist">
												...
												<div class="row mainpric bg-light">
													...
													<div class="col-md-6 col-xs-6"><span class="label1"><strong id="couponDiscountLabel">Coupon/Offer Discount :</strong></span></div>
													<div class="col-md-6 col-xs-6 text-right"><span class="value1" id="couponDiscount"></span></div>
													<b style="border-bottom:1px dashed black;margin-top:5px;"></b>
													
													<div class="col-md-6 col-xs-6"><span class="label1"><strong>Discount Applied On:</strong></span></div>
													<div class="col-md-6 col-xs-6 text-right"><span class="value1" id="discountAppliedOn"></span></div>
													
													<div class="col-md-6 col-xs-6"><span class="label1" id="discountLabel"><strong id="discountLabel">Discount :</strong></span></div>
													<div class="col-md-6 col-xs-6 text-right"><span class="value1" id="discountText"></span></div>
												
													<b style="border-bottom:1px dashed black;margin-top:5px;"></b>
													
													<div class="col-md-6 col-xs-6"><span class="label1"><strong>Total :</strong></span></div>
													<div class="col-md-6 col-xs-6 text-right"><span class="value1" id="taxAppliedOn"></span></div>
													
													<div class="col-md-6 col-xs-6"><span class="label1"><strong>Tax :</strong></span></div>
													<div class="col-md-6 col-xs-6 text-right"><span class="value1" id="taxText"></span></div>
