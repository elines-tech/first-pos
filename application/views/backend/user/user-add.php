                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3>Add User <span style="float:right"><a href="<?= base_url() ?>users/listRecords" id="btnClear" class="btn btn-sm btn-primary">Back</a></span></h3>
                        </div>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <form class="form" method="post" action="<?php echo base_url(); ?>users/save" id="addUserForm" enctype="multipart/form-data" data-parsley-validate="">
                                        ...
                                        <div class="col-md-12 row d-flex justify-content-center mt-3">
                                ...
                                <div class="row">
                                    <div class="col-12 d-flex justify-content-end">
                                        ...
                                        <button id="btnClear" type="reset" class="btn btn-light-secondary">Reset</button>
                                    </div>
                                </div>
                                </form>
