                                ...
                                <div class="row">
                                    ...
                                    <form class="form" id="editUserForm" enctype="multipart/form-data" data-parsley-validate method="post" action="<?php echo base_url(); ?>Profile/updateUserProfile">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-2" id="loginPinDetails" style="display:<?= $userData[0]['userRole'] != 'R_5' ? '' : 'none' ?>">
                                                <div class="form-group mandatory">
                                            ...
                                            <div class="col-md-2 mt-sm-4" id="loginPinDetails1" style="display:<?= $userData[0]['userRole'] != 'R_5' ? '' : 'none' ?>">
